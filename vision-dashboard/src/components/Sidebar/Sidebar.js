...
function Sidebar(props) {
  ...
  const createLinks = (routes) => {
    ...
    // Chakra Color Mode
    let activeBg = "rgba(10, 10, 10)";
    let inactiveBg = "rgba(10, 10, 10, 0.37)";
  ...
  //  Chakra Color Mode
  let sidebarBg =
    "linear-gradient(111.84deg, #000000 59.3%, rgba(26, 31, 55, 0) 150%)";
  ...
  return (
    <Flex
      ...
      <Drawer
        ...
        <DrawerContent
          backdropFilter='blur(10px)'
          bg='linear-gradient(111.84deg, rgb(0, 0, 0) 59.3%, rgba(26, 31, 55, 0) 100%); '
          w='250px'
          maxW='250px'
          ms={{
            sm: "16px",
